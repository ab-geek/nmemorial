...
urlpatterns = [
    ...
    #url(r'^api/forgot_pw/', views.forgot_pw),
    #url(r'^api/get_pins/', views.get_pins),
    #url(r'^api/add_pins/', views.add_pins),
    #url(r'^api/search/', views.search),
    #url(r'^api/add_story/', views.add_story),
    #url(r'^api/edit_story/(?P<string>\w+)', views.edit_story),
    #url(r'^api/delete_story/(?P<string>\w+)', views.delete_story)
